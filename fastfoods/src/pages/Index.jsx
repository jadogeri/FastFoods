...
<div className="header-banner" id="head">
    ...
    <div className="callbacks_container">
      <ul className="rslides" id="slider">
        <li>
          ...
          <div
            className="caption wow bounceIn animated"
            data-wow-delay="0.4s"
            style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
          >
            <div className="logo">
        ...
        <li>
          ...
          <div
            className="caption wow bounceInLeft animated"
            data-wow-delay="0.4s"
            style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
          >
            <div className="logo">
        ...
        <div className="top-menu">
          ...
          <ul>
            <nav className="cl-effect-5">
              ...
              <li>
                <a href="menu.html">
                  <span data-hover="menus">menus</span>
                </a>
              </li>
              <li>
                <a href="event.html">
                  <span data-hover="event">event</span>
                </a>
              </li>
              <li>
                <a className="scroll" href="#tests">
                  <span data-hover="Tests">tests</span>
                </a>
              </li>
              <li>
  ...
  <div className="content">
    ...
    <div className="video">
      <iframe
        src="https://player.vimeo.com/video/33132310"
        frameBorder={0}
    ...
    <div className="about-section" id="about">
      <div className="container">
        <h3>about us </h3>
        <div
          className="main wow bounceInLeft animated"
          data-wow-delay="0.4s"
          style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
        >
    ...
    <div className="events-section">
      <div className="container">
        <h3>our events</h3>
        <div
          className="event-grids  wow bounceInRight animated"
          data-wow-delay="0.4s"
          style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
        >
            ...
            <div className="even-info">
              ...
              <div className="event-info">
                ...
                <p>
                  ...
                  Quisque cursus, sem eget sagittis sagittis, nisl magna sodales
                  eros, ut feugiat velit velit non turpis. Cras eu nibh dapibus
                  justo fringilla{" "}
                </p>
              </div>
        ...
        <div className="butt">
          <a href="event.html" className="button2">
            veiw all events
          </a>
        </div>
      </div>
    ...
    <div className="test-section" id="tests">
      <div className="container">
        ...
        <div className="test-grids ">
          <div
            className="test-grid1 wow bounceInRight animated"
            data-wow-delay="0.4s"
            style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
          >
            ...
            <div className="col-md-7 test-right">
              ...
              <p>
                Quisque varius, nibh ac feugiat interdum, libero massa laoreet
                tellus, nec congue lorem arcu a nunc. Praesent quis felis eget
                elit semper pharetra sollicitudin id nibh. Praesent venenatis
                lectus ornare, porta risus quis, commodo nulla. Nunc adipiscing
                ipsum lacinia diam pulvinar aliquet. Mauris sit{" "}
              </p>
            </div>
            <div className="clearfix"> </div>
          </div>
          <div
            className="test-grid2 wow bounceInLeft animated"
            data-wow-delay="0.4s"
            style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
          >
            <div className="col-md-7 test-left01">
              ...
              <p>
                Vestibulum et consequat justo. Maecenas ultrices malesuada leo
                porta venenatis. Sed sit amet diam facilisis, interdum tellus
                nec, dignissim massa. Vestibulum ante ipsum primis in faucibus
                orci luctus et ultrices posuere cubilia Curae; Suspendisse
                consequat purus est, nec venenatis est sagittis in.{" "}
              </p>
            </div>
          ...
          <div
            className="test-grid3 wow bounceInRight animated"
            data-wow-delay="0.4s"
            style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
          >
            <div className="col-md-5 test-left test1">
    ...
    <div className="google" id="location">
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d52300.033408044306!2d33.999559!3d34.987874!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14dfc513650b8f37%3A0x2497459334310f21!2sNapa+Plaza+Hotel!5e0!3m2!1sen!2sin!4v1428737227572">
        {" "}
      </iframe>
    </div>
    <div className="contact-section">
      <div className="container">
        <h3>contact us</h3>
        <div
          className="contact-grids wow bounceInRight animated"
          data-wow-delay="0.4s"
          style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
        >
          "&gt;
  ...
  <div className="footer-section">
    <div className="container">
      <div
        className="footer-top wow bounceInRight animated"
        data-wow-delay="0.4s"
        style={{ visibility: "visible", WebkitAnimationDelay: "0.4s" }}
      >
        "&gt;
